...
const pupugContainer = document.getElementById('pupug-container');
const pupug = document.getElementById('pupug');
...
function showpupug() {
    ...
    pupugContainer.style.display = 'block';
    setTimeout(closepupug, 20000); 
}

function closepupug() {
    pupugContainer.style.display = 'none';
}

closeButton.addEventListener('click', closepupug);


setTimeout(showpupug, 3000);
